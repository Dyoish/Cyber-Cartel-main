        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-sm-10">
                ...
                <form action="{{url('edit_address/' . $address->id . '')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <a href="/address" class="btn btn custom-btn-highlight" style="width: 49%;">Back</a>
                    <button type="submit" class="btn btn custom-btn-highlight" style="width: 48%;">Update
                    </button>
                    </button>
            </div>
            </form>
...
<!-- Footer Section -->
<footer class="bg-black text-light text-center py-1 fixed-bottom"
