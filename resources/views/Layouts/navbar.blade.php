    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <div class="container-fluid">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="login" style="margin-right: 2vw">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="signup" style="margin-right: 2vw">Signup</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/adminlogin" style=" margin-right: 3vw">Admin</a>
                </li>
            </ul>
        </div>
    </div>
