    ...
    <div class=" container">
        <div class="row">
            ...
            <div class="col-md text-right pr-md-2">
                <p style="margin-top: 15px; margin-right: -500px;"><a href="https://www.facebook.com/cybercartelpage"
                        class="text-light" style="text-decoration: none;">Follow us on Facebook</a></p>
            </div>
        </div>
    </div>
</footer>